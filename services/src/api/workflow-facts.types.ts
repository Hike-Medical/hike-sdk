...
/**
 * Maps EvaluationAttachmentType values to the FactRegistry keys expected
 * from extraction for that document type. Derived from the extraction
 * prompts configuration (CPO_v2.0/prompts.json categories → sections → fields).
 *
 * Excludes internal, deprecated, and hideInUX facts.
 */
