/**
 * X12 Service Type Codes (STC) for healthcare eligibility checks (X12 005010)
 * @see https://www.stedi.com/docs/healthcare/eligibility-stc-procedure-codes#full-stc-list
 */
export enum ServiceTypeCode {
  ...
  USED_DME = '11',
  DME_PURCHASE = '12',
  AMBULATORY_SERVICE_CENTER = '13',
  RENAL_SUPPLIES_HOME = '14',
  ...
  PROFESSIONAL_PHYSICIAN_VISIT_SKILLED_NURSING = 'A2',
  ...
  SURGICAL_BENEFITS_PROFESSIONAL = 'CC',
  ...
  MAMMOGRAM_HIGH_RISK = 'CM',
  MAMMOGRAM_LOW_RISK = 'CN',
  FLU_VACCINATION = 'CO',
...
/**
 * Helper type for service type code values
 */
export type ServiceTypeCodeValue = `${ServiceTypeCode}`;

/**
 * Get all available service type codes
 */
export const getAllServiceTypeCodes = (): ServiceTypeCodeValue[] =>
  Object.values(ServiceTypeCode) as ServiceTypeCodeValue[];

/**
 * Check if a string is a valid service type code
 */
export const isValidServiceTypeCode = (code: string): code is ServiceTypeCodeValue =>
  Object.values(ServiceTypeCode).includes(code as ServiceTypeCode);
