...
export type * from './dto/appointment/CreateAppointmentParams';
export type * from './dto/appointment/DeleteAppointmentParams';
export type * from './dto/appointment/GetAppointmentsParams';
...
export type * from './dto/s3/CreatePresignedUrlParams';
